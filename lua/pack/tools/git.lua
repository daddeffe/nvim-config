...
local function load_unclash()
  vim.cmd.packadd 'unclash.nvim'
...
lazy.by_key('unclash.nvim', 'n', '<leader>hco', load_unclash, function() vim.cmd 'UnclashOpenMergeEditor' end, { desc = '[C]onflict merge editor' })
lazy.by_key('unclash.nvim', 'n', '<leader>hcc', load_unclash, function() vim.cmd 'UnclashAcceptCurrent' end, { desc = '[C]onflict accept [C]urrent' })
lazy.by_key('unclash.nvim', 'n', '<leader>hci', load_unclash, function() vim.cmd 'UnclashAcceptIncoming' end, { desc = '[C]onflict accept [I]ncoming' })
lazy.by_key('unclash.nvim', 'n', '<leader>hcb', load_unclash, function() vim.cmd 'UnclashAcceptBoth' end, { desc = '[C]onflict accept [B]oth' })

lazy.by_cmd('vim-fugitive', 'Git', nil, 'Git')
lazy.by_cmd('vim-fugitive', 'Gdiffsplit', nil, 'Gdiffsplit')
lazy.by_cmd('lazygit.nvim', 'LazyGit', nil, 'LazyGit')
